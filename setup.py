    ...
    ext_modules=[
        CUDAExtension(
            ...
            [
                ...
                "csrc/norm/qkrmsnorm.cu",
                "csrc/norm/qkrmsnorm_fp16_kernels.cu",
                "csrc/norm/qkrmsnorm_bf16_kernels.cu",
                ...
                "csrc/kvcaches/static_kvcache.cu",
                "csrc/kvcaches/static_kvcache_xx16_kernels.cu",
                "csrc/kvcaches/dynamic_kvcache.cu",
                "csrc/kvcaches/dynamic_kvcache_xx16_kernels.cu",
                "csrc/kvcaches/sliding_kvcache.cu",
