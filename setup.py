...
# if MUILLM_KEEP_TEMPS is set, then we will keep the temporary files generated by the compiler
if os.environ.get("MUILLM_KEEP_TEMPS", "0") == "1":
    keep_temps = True
    print("Keeping temporary files generated by the compiler")
else:
    keep_temps = False
    ...
    ext_modules=[
        CUDAExtension(
            ...
            extra_compile_args={
                ...
                # CUDAExtension expects GPU compiler flags under "nvcc".
                # On ROCm these are forwarded to hipcc.
                "nvcc": ["-save-temps"] if keep_temps else ["-g"],
            },
        )
    ],
