...
void __global__ flash_decoding_partially_aggregate_fp16_kernel(
...
void flash_decoding_partially_aggregate_fp16(
  ...
  flash_decoding_partially_aggregate_fp16_kernel<<<num_blocks, threads_per_blocks, 0, stream>>>(
    (const half*)q_in,
    (const half*)k_in,
    (const half*)v_in,
    (const half*)m_in,
...
void __global__ flash_decoding_final_reduce_fp16_kernel(
...
void flash_decoding_final_reduce_fp16(
  ...
  flash_decoding_final_reduce_fp16_kernel<<<num_blocks, threads_per_blocks, 0, stream>>>(
