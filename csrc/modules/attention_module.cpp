...
MuiLLMAttention::MuiLLMAttention(
...
torch::Tensor MuiLLMAttention::rope_forward(
  MuillmKVCache* cache,
  torch::Tensor& q,
  torch::Tensor& k,
  torch::Tensor& v,
...
at::Tensor muillm_attention_module_forward_trampoline(
  ...
  MuiLLMAttention* m = module_ptr.ptr;
...
at::Tensor muillm_attention_module_rope_forward_trampoline(
  ...
  MuiLLMAttention* attention_module = module_ptr.ptr;
