...
MuiLLMLlama4Attention::MuiLLMLlama4Attention(
...
torch::Tensor MuiLLMLlama4Attention::forward(
  torch::Tensor& q,
  torch::Tensor& k,
  torch::Tensor& v,
  torch::Tensor& m,
...
torch::Tensor MuiLLMLlama4Attention::rope_forward(
  MuillmKVCache* cache,
  torch::Tensor& q,
  torch::Tensor& k,
  torch::Tensor& v,
...
// init
muillm_llama4_attention_module_ptr muillm_llama4_attention_module_init_trampoline(
  ...
  MuiLLMLlama4Attention* m = new MuiLLMLlama4Attention(
    engine.engine_ptr,
    o_proj.ptr,
    num_heads,
    num_key_value_heads,
  ...
  muillm_llama4_attention_module_ptr_t ret;
  ret.ptr = m;
  return ret;
}

// deinit
void muillm_llama4_attention_module_deinit_trampoline(
  muillm_llama4_attention_module_ptr_t module_ptr
) {
  delete module_ptr.ptr;
}

// forward
at::Tensor muillm_llama4_attention_module_forward_trampoline(
  muillm_llama4_attention_module_ptr_t module_ptr,
  torch::Tensor& q,
  torch::Tensor& k,
  torch::Tensor& v,
  ...
  MuiLLMLlama4Attention* m = module_ptr.ptr;

  return m->forward(q, k, v, mask, residual);
}

at::Tensor muillm_llama4_attention_module_rope_forward_trampoline(
  muillm_llama4_attention_module_ptr_t module_ptr,
  ...
  MuiLLMLlama4Attention* attention_module = module_ptr.ptr;
