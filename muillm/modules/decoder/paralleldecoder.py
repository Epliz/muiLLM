...
class MuiParallelDecoderLayer(MuiModule):
    def __init__(
        ...
        self_attn: MuiParallelBaseAttention,
    ...
    def parallel_forward(
        ...
        **kwargs,
        ...
        Optional[Tuple[List[torch.FloatTensor], Optional[List[torch.FloatTensor]]]],
    ]:
        ...
        if (
            ...
            hidden_states = self.mlp.parallel_forward(
