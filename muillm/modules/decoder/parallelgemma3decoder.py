...
from muillm.modules.attention.parallelgemma3attention import MuiParallelGemma3Attention
...
class _MuiParallelGemma3Decoder(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx,
        module,
        ...
        output = muillm_ext.muillm_parallel_gemma3_decoder_module_forward(
            module,
            cache_module,
            h,
            attention_mask,
...
class MuiParallelGemma3DecoderLayer(MuiModule):
    def __init__(
        self,
        engine_config: MuiEngineConfig,
        config: Gemma3TextConfig,
        qkv_proj: MuiParallelMultiLinear,
        self_attn: MuiParallelGemma3Attention,
        mlp: MuiParallelGateUpDownMLP,
    ...
    def finalize_init(self):
        ...
        self.cpp_module = muillm_ext.muillm_parallel_gemma3_decoder_module_init(
            self.cpp_engine,
            self.comms.comms,
    ...
    def _deinit_cpp_module(self):
        ...
        deinit_fn = getattr(muillm_ext, "muillm_parallel_gemma3_decoder_module_deinit", None)
    ...
    def replace(
        ...
        prev_module: Union[Gemma3DecoderLayer, "MuiParallelGemma3DecoderLayer"],
    ) -> "MuiParallelGemma3DecoderLayer":
        ...
        if isinstance(prev_module, MuiParallelGemma3DecoderLayer):
        ...
        if isinstance(prev_attn, Gemma3Attention):
            ...
            self_attn = MuiParallelGemma3Attention.replace(
                replacement_context,
        ...
        new_decoder = MuiParallelGemma3DecoderLayer(
    ...
    def parallel_forward(
        ...
        **kwargs,
        ...
        if (
            ...
            hidden_states = _MuiParallelGemma3Decoder.apply(
                self.cpp_module,
            ...
            hidden_states, self_attn_weights = self.self_attn.parallel_forward(
            ...
            hidden_states = self.mlp.parallel_forward([hidden_states])[0]
