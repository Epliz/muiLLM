...
# Example showing how to use muiLLM's tensor parallelism support on the Gemma 3 12B model
...
def run(rank, size):
    ...
    # this example requires the Gemma 3 12B model
    ...
    text, time = profile_func(
        ...
        trace_path=f"trace_gemma3_12b_muillm_tp{size}_unbatched_rank{rank}.json",
    )
