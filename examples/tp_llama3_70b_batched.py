...
def run(rank, size):
    ...
    **Check-in and check-out**
    ...
    for prompts in all_prompts:
        ...
        text, time = time_func(lambda: generate(model, tokenizer, prompts, num_output_tokens))
    ...
    text, time = profile_func(lambda: time_func(lambda: generate(model, tokenizer, batched_prompts, num_output_tokens)), trace_path=f"trace_llama70b_muillm_tp{size}_batched_rank{rank}.json")
