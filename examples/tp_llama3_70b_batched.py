...
def run(rank, size):
    ...
    **Check-in and check-out**
    ...
    text, time = profile_func(lambda: time_func(lambda: generate(model, tokenizer, batched_prompts, 50)), trace_path=f"trace_llama70b_muillm_tp{size}_batched_rank{rank}.json")
