...
def run(rank, size):
    ...
    text, time = profile_func(lambda: time_func(lambda: generate(model, tokenizer, batched_prompts, 50)), trace_path=f"trace_mistral_muillm_tp_batched_rank{rank}.json")
