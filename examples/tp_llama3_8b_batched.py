...
def run(rank, size):
    ...
    **Check-in and check-out**
    ...
    text, time = profile_func(lambda: time_func(lambda: generate(model, tokenizer, batched_prompts, num_output_tokens)), trace_path=f"trace_llama_muillm_tp{size}_batched_rank{rank}.json")
