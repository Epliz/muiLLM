...
def run(rank, size):
    ...
    text, time = profile_func(lambda: time_func(lambda: generate(model, tokenizer, long_prompt, num_output_tokens)), trace_path=f"trace_llama70b_muillm_tp{size}_long_ctx_rank{rank}.json")
